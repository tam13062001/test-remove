    ...
    <div class="absolute inset-0 flex items-end lg:items-center z-10 px-4 pb-8 lg:pb-0">
        <div class="container mx-auto">
            <h1 class="font-bold text-white text-[32px] lg:text-[72px] lg:leading-[120%]">
                <div class="ml-0 sm:ml-0 md:ml-0 lg:ml-0 font-[600]">Pioneering</div>
                <div class="ml-8 sm:ml-12 md:ml-24 lg:ml-36 font-[600]">the Future of</div>
                <div class="ml-4 sm:ml-6 md:ml-8 lg:ml-12 font-[600]">Digital Innovation</div>
            </h1>
        </div>
    </div>
</div>
...
<div class="container py-[60px] lg:py-[100px]">
    <h1 class="text-[32px] font-[600] lg:text-[40px] font-bold mb-10 lg:mb-16">
        What Sets Us Apart
    </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 xl:gap-12">
        ...
        <div class="bg-white rounded-lg relative h-[346px] lg:h-[520px]">
            ...
            <div class="text-white relative p-6 flex flex-col justify-between h-full">
                <h2 class="text-2xl font-bold mb-4 mt-4 font-[500]">Data & AI</h2>
                <p class="font-[200] lg:mb-8">
        ...
        <div class="bg-white rounded-lg relative h-[346px] lg:h-[520px]">
            <video
                ...
                loop
            >
                <source src="<?php echo get_assets_from_path('videos/cloud_banner_video.mp4') ?>" type="video/mp4">
            </video>
            <div class="text-white relative p-10  flex flex-col justify-between h-full">
                <h2 class="text-2xl font-bold mb-4 mt-4 font-[500]">Cloud Solutions</h2>
                <p class="font-[200] lg:mb-8 ">
        ...
        <div class="bg-white rounded-lg relative h-[346px] lg:h-[520px]">
            ...
            <div class="text-white relative p-6 flex flex-col justify-between h-full">
                <h2 class="text-2xl font-bold mb-4 mt-4 font-[500]">Software Engineering</h2>
                <p class="font-[200] lg:mb-8">
...
<div class="relative lg:pt-[200px]">
    ...
    <div class="container py-[100px] lg:py-[100px] mx-auto px-4 xl:px-0">
        <div class="text-center">
            ...
            <p class="lg:leading-9 lg:w-[600px] text-[20px] sm:text-[16px] font-Regular mb-12 leading-normal lg:max-w-3xl mx-auto text-center">

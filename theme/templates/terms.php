...
<div class="container lg:pt-[200px] leading-[170%]">
    ...
    When using this Website, you agree to:
        ...
        <ul class="list-disc pl-5 lg:ml-[14px]">
            <li>Use the Website only for lawful purposes.</li>
            <li>Refrain from engaging in any activity that disrupts or interferes with the Website’s functionality.</li>
            <li>Avoid uploading or transmitting harmful, offensive, or unauthorized content.</li>
            <li>Datum Consulting Group reserves the right to restrict access to users who violate these terms.</li>
        </ul>
    ...
    When using this Website, you agree to:
        ...
        <ul class="list-disc pl-5 lg:ml-[14px]">
            ...
            <li>Perform activities such as sniffing, Distributed Denial of Service (DDoS) attacks, SQL injection, or unauthorized crawling.</li>
            <li>Misuse the website's content or functionality in any way that disrupts its operation or compromises its security.</li>
            <li>Datum Consulting Group reserves the right to take appropriate action, including restricting access if prohibited uses are detected.</li>
        </ul>
    <p class="lg:mt-[4px] lg:mb-[4px] font-regular lg:text-[20px] ">
    ...
    <p class="lg:mt-[4px] lg:mb-[4px] font-regular lg:text-[20px] ">
    The Website and its content are provided "as is" without any warranties, express or implied. Datum Consulting Group does not guarantee the accuracy, completeness, or reliability of the information on the Website.

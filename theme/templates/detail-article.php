...
<div class="container lg:py-[40px]  leading-[170%] lg:hidden "> 
    <h1 class="my-[30px] font-bold lg:text-[20px] text-[24px] lg:mt-[50px] ">
    ...
    <p class="lg:mt-[4px] lg:mb-[4px] font-regular lg:text-[20px] text-[14px] ">
        The Tech and Digital industry is a confluence of a broad and diverse segment of organizations, made up of capitals, semiconductor firms, platforms, software, and the electronic hardware and networking companies that drive the digital transformation of all the other industries. With innovations such as customized chips and AI workflows, rapid advancements in each of the Tech and Digital sectors promise disruption across all the other industry verticals. 2025 holds immense promise across all of these sectors.
    </p>

    <p class="my-[30px] lg:mb-[4px] font-regular lg:text-[20px] text-[14px] ">
...
<div class="container lg:py-[40px]  leading-[170%]"> 
    <h1 class="my-[30px] font-bold lg:text-[20px] text-[22px] lg:mt-[50px] ">
    ...
    <div>
        <h3 class="mt-[40px] lg:text-[20px] text-[14px] ">New trends in platforms include:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px] ">
            <li>1. AI-Native Platforms</li>
            <li>2. Platforms as a Market Place</li>
            <li>3. Super Platforms and interoperability</li>
        </ol>

        <p class="mb-[20px] lg:text-[20px] text-[14px] ">
    ...
    <div>
        ...
        <h3 class="mt-[40px] lg:text-[20px] text-[14px] ">These chips are also being utilized for various purposes, including:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px]  list-disc list-inside">
        ...
        <h3 class="mt-[40px] lg:text-[20px] text-[14px] ">Across industries, companies are working on specialized processors, designed for AI applications. For example:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px]  list-disc list-inside">
    ...
    <h1 class="pb-[15px] lg:pb-0 pt-[30px] lg:pt-0 font-bold text-[20px]   lg:mt-[50px] ">
        About the Author
    </h1>

    <h1 class="lg:mt-[4px] font-bold text-[20px]  text-[#315CD4] lg:mt-[50px] ">
        Nick Do
    </h1>

    <p class="lg:mt-[4px] mb-10 lg:mb-[4px] font-regular lg:text-[20px] text-[14px] ">
        Co-founder
    </p>

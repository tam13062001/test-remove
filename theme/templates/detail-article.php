<?php /* Template Name: Detail Article  Template */ ?>

<?php get_header(); ?>

<?php get_template_part('template-parts/content/banner', null, array(
    'title' => 'Tech and Digital 2025 – The start of geo and tranversal tech',
    'background_image' => get_assets_from_path('images/Detail Article.jpg'),
    'breadcrumbs' => array('Insights', 'Detail Article'),
)); ?>

<div class="lg:block hidden">
  <?php
    get_template_part('template-parts/content/call-to-action-story-insights', null, array(
        'title' => '12, May, 2025',
        'heading' => 'The year 2024 saw elections in over 70 countries, a historical high for any single year. Many national agendas cited tech, and the need for self-sufficiency and sovereignty as national priorities. 
    ',
        'content' => 'The Tech and Digital industry is a confluence of a broad and diverse segment of organizations, made up of capitals, semiconductor firms, platforms, software, and the electronic hardware and networking companies that drive the digital transformation of all the other industries. With innovations such as customized chips and AI workflows, rapid advancements in each of the Tech and Digital sectors promise disruption across all the other industry verticals. 2025 holds immense promise across all of these sectors.',
...
<div class="container lg:py-[40px]  leading-[170%] lg:hidden "> 
    <h1 class="my-[30px] font-bold lg:text-[20px] text-[24px] lg:mt-[50px] lg:w-3/5">
    ...
    <p class="lg:mt-[4px] lg:mb-[4px] font-regular lg:text-[20px] text-[14px] lg:w-3/5">
        The Tech and Digital industry is a confluence of a broad and diverse segment of organizations, made up of capitals, semiconductor firms, platforms, software, and the electronic hardware and networking companies that drive the digital transformation of all the other industries. With innovations such as customized chips and AI workflows, rapid advancements in each of the Tech and Digital sectors promise disruption across all the other industry verticals. 2025 holds immense promise across all of these sectors.
    </p>

    <p class="my-[30px] lg:mb-[4px] font-regular lg:text-[20px] text-[14px] lg:w-3/5">
        Here are the more secular macro trends by segments in the Tech and Digital industry
    </p>

</div>

<div class="container lg:pt-[100px] lg:pb-[100px]">
    <img src="<?php echo get_assets_from_path('images/image 21.jpg') ?>" alt="">
</div>

<div class="container lg:py-[40px]  leading-[170%]"> 
    <h1 class="my-[30px] font-bold lg:text-[20px] text-[22px] lg:mt-[50px] lg:w-3/5">
    ...
    <div>
        <h3 class="mt-[40px] lg:text-[20px] text-[14px] lg:w-3/5">New trends in platforms include:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px] lg:w-3/5">
            <li>1. AI-Native Platforms</li>
            <li>2. Platforms as a Market Place</li>
            <li>3. Super Platforms and interoperability</li>
        </ol>

        <p class="mb-[20px] lg:text-[20px] text-[14px] lg:w-3/5">
        ...
        <p class="mb-[20px] lg:text-[20px] text-[14px] lg:w-3/5">
            Positioning the future of the Tech and Digital industry for platform and software companies lies in the contextually rich intersections of industry verticals. There is a significant opportunity in contextual specialization within this wealth of knowledge. Platform and software players (who boast a <strong>CAGR of over 12%</strong>) are defining the future and helping shape the tech’s fastest addressable market, valued in billions of dollars. They lead the innovation agenda globally and have the highest propensity to outsource.
        </p>
    </div>
    ...
    <div>
        <h3 class="mt-[40px] lg:text-[20px] text-[14px] lg:w-3/5">Many of the chips designed for training and using Gen AI cost tens of thousands of dollars and are primarily destined for large cloud data centers. However, by 2025, Gen AI chips or lightweight versions of these chips are expected to be found in various other locations, including:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px] lg:w-3/5 list-disc list-inside">
            <li>Enterprise Edge: These chips will be integrated into enterprise edge devices, enhancing their capabilities.</li>
            <li>Computers: Both personal and enterprise computers will start incorporating these advanced chips.</li>
            <li>Smartphones: Mobile devices will benefit from the power of Gen AI chips, enabling more sophisticated applications.</li>
            <li>Other Edge Devices: Over time, other edge devices such as IoT applications will also adopt these chips.</li>
        </ol>

        <h3 class="mt-[40px] lg:text-[20px] text-[14px] lg:w-3/5">These chips are also being utilized for various purposes, including:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px] lg:w-3/5 list-disc list-inside">
            <li>Generative AI: For creating new content and applications.</li>
            <li>Traditional AI (Machine Learning): For tasks such as data analysis and predictive modeling.</li>
            <li>Combination of both: Increasingly, these chips are being used for a combination of Gen AI and traditional AI tasks, providing versatile and powerful solutions.</li>
        ...
        <h3 class="mt-[40px] lg:text-[20px] text-[14px] lg:w-3/5">Across industries, companies are working on specialized processors, designed for AI applications. For example:</h3>
        <ol class="py-[40px] lg:text-[20px] text-[14px] lg:w-3/5 list-disc list-inside">
            <li>Amazon Web Services (AWS) and Google have begun developing their own chips to reduce reliance on overstretched players like Nvidia. These chips are tailored for specific workloads, ensuring greater control and efficiency.</li>
            <li>With the rise of electric vehicles and autonomous driving technologies, automotive semiconductors are becoming increasingly critical.</li>
        </ol>
    ...
    <p class="lg:mt-[4px] lg:mb-[4px] font-regular lg:text-[20px] text-[14px] lg:w-3/5">
        The demand for AI infrastructure is on a vertical rise leading to energy-efficient compute & cooling innovations with a massive focus on power efficiency due to AI compute intensity.t This entails an adoption of liquid cooling, chip-level thermal design, and carbon-aware scheduling.
    </p>
    <p class="lg:mt-[4px] lg:mb-[4px] font-regular lg:text-[20px] text-[14px] lg:w-3/5">
    ...
    <h1 class="pb-[15px] lg:pb-0 pt-[30px] lg:pt-0 font-bold text-[20px]   lg:mt-[50px] lg:w-3/5">
        About the Author
    </h1>

    <h1 class="lg:mt-[4px] font-bold text-[20px]  text-[#315CD4] lg:mt-[50px] lg:w-3/5">
        Nick Do
    </h1>

    <p class="lg:mt-[4px] mb-10 lg:mb-[4px] font-regular lg:text-[20px] text-[14px] lg:w-3/5">
        Co-founder
    </p>
...
get_template_part('template-parts/content/late-new-event', null, array(
    ...
    'news_items' => array(
        array(
            ...
            'image_url' => get_assets_from_path('images/detail-1.jpg')
        ),
        array(
            'title' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.',
            'date' => 'Event 12,May,2025',
            'image_url' => get_assets_from_path('images/detail-2.jpg')
        ),
    )
));
?>

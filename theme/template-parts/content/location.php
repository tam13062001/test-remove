    ...
    <div class="container pt-[50px] lg:py-[100px] z-10 relative">
        ...
        <div class="w-[900px] ">
            <div class="bg-[#C4E1F5] p-8 ">
                <h2 class="text-[24px] font-bold text-[#315CD4] mb-6 pb-4 border-b border-gray-200">
                    New Zealand
                </h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-300 pb-6">
                        <h2 class="text-[24px] font-bold text-[#315CD4] mb-4">
                            Australia
                        </h2>
                    </div>
                    ...
                    <div>
                        <h2 class="text-[24px] font-bold text-[#315CD4]">
                            Philippines
                        </h2>
                    </div>
                </div>

...
<h1 class="container text-2xl md:text-3xl pt-[50px] lg:py-[100px] lg:text-[40px] font-bold mb-6 lg:mb-12 px-4 lg:px-0">
    Locations
</h1>
...
<div class="relative lg:min-h-[880px] mb-10 lg:mb-20">
    ...
    <!-- Content Container -->
    <div class="container lg:pt-[50px] lg:py-[100px] -mt-[20px] z-10 relative px-4 lg:px-0 mb-6">
        <div class="lg:w-[800px] w-full lg:h-[588px] h-auto">
            ...
            <div class="cursor-pointer" @click="showNZ = !showNZ">
                ...
                <div class="space-y-4 lg:space-y-6 mt-6"x-data="{ showA: false }">
                    <div class="  flex justify-between cursor-pointer"@click="showA = !showA">
                ...
                <div class="border-b border-[#FFFFFF]"></div>
                    <div class="border-b border-[#FFFFFF] pb-4 lg:pb-6 flex justify-between">
                        <h2 class="text-lg md:text-xl lg:text-[24px] font-bold text-primary  lg:mt-4 ml-4 lg:ml-12">
                            VietNam
                        </h2>
                        <i :class="showNZ ? 'fa-solid fa-minus' : 'fa-regular fa-plus'" class="mt-1 lg:mt-7 text-[#3DA7F2] mr-4 lg:mr-12"></i>
                    </div>

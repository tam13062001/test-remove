<div class="container py-[60px] lg:py-[120px]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div class="border-b border-secondary">
            <button  class="flex items-center  lg:py-12 px-8 lg:text-[24px] text-[16px] font-[700] text-primary leading-[170%] bg-gradient-to-r from-secondary/20 to-primary/20 h-[140px] lg:h-[220px]">

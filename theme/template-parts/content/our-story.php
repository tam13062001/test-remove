        ...
        <div class="container py-[60px] lg:py-0">
            <div class="bg-white lg:w-[787px] lg:px-[123px] lg:py-[70px] lg:shadow-lg">
                ...
                <div class="lg:leading-10 text-Regular text-base sm:text-lg lg:text-[20px] mb-8">
                    Founded in 2017, Datum Consulting is an engineering and
                    digital transformation consultancy based in Auckland, New
                    Zealand. We've partnered with businesses of all sizes—from
                    ambitious startups to one of Australia's Big Four banks—to

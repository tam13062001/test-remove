    ...
    <div class="h-[670px] w-full lg:h-[824px] relative">
        ...
        <img class="w-full h-full object-cover sm:object-cover" style="object-position: 67% ;"
             src="<?php echo get_stylesheet_directory_uri() . '/assets/images/BG 1.jpg' ?>" alt="Hero Background" />
        <div class="absolute -ml-[40px] inset-0 flex items-end lg:items-center z-10 pb-8 lg:pb-0">
            <div class="container mx-auto">
                <h1 class="font-bold ml-[5px] text-white text-[32px] lg:text-[72px] lg:leading-[120%]">

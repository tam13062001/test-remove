...
<div class="relative lg:h-[625px] lg:mb-[200px]">
    ...
    <div class="container z-10 relative ">
        ...
        <div class="lg:w-1/2 lg:h-[300px] bg-white lg:py-9 lg:pr-[100px] leading-[170%] ">
            ...
            <div class="mb-10">
                ...
                <?php } ?>
                <div class="lg:text-[20px] text-[16px] font-Regular mb-3"><?php echo $item['content']; ?></div>
            </div>
            <?php endforeach; ?>
        </div>
    </div>

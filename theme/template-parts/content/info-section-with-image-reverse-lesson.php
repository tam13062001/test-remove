...
<div class="relative lg:min-h-[880px] lg:mb-[88px]">
    ...
    <div class="container pt-[40px] lg:pt-0 z-10 relative">
        ...
        <div class="relative lg:absolute top-0 right-0 lg:h-[700px] lg:w-[750px] bg-white pt-6 lg:pt-5 lg:pl-[60px] ">
            <div class="lg:w-full font-bold text-[32px] lg:text-[40px] lg:mb-[10px]">
                <h2>
                    <?php echo $title ?>
                </h2>
            </div>  

    ...
    <div class="relative container">
        ...
        <div class="space-y-8 lg:space-y-20">
            <?php foreach ($items as $index => $item): 
                $alignmentClass = $index % 2 === 0 ? 'lg:ml-1' : 'lg:mr-1 justify-end';
            ?>
                <div class="w-full flex flex-col lg:flex-row <?php echo $alignmentClass; ?> h-auto lg:h-[453px]">
                    <div class="w-full lg:w-[782px] bg-white p-4 sm:p-6 lg:p-10 shadow-[0_0_10px_rgba(0,0,0,0.1)]">
                        ...
                        <p class="text-[14px] sm:text-[16px] lg:text-[24px] mb-3 lg:mb-6 leading-[170%] ml-0 sm:ml-6 lg:ml-20">
                            <?php echo datum_translate($item['desc']); ?>
                        </p>
                        <a href="<?php echo esc_url($item['link']); ?>" class="text-primary inline-flex items-center text-[16px] sm:text-[16px] lg:text-[20px] mt-6 sm:mt-10 lg:mt-20 ml-0 sm:ml-6 lg:ml-20">

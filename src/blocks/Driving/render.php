...
<div class="relative text-white">
    <div class="absolute top-0 left-0 right-0 h-full w-full bg-app-gradient">
        <img class="object-cover h-full w-full" src="<?php echo esc_url($image_url); ?>" alt="impact background" />
    </div>

    <div class="container relative py-[60px] lg:py-[142px]">
        <div class="text-[24px] font-bold lg:w-[785px] w-full ">
            <?php echo esc_html($title); ?>
        </div>
        <div class="text-[20px] font-bold py-[30px] lg:py-[40px] lg:w-[785px] w-full ">
                ...
                <?php foreach ($items as $item): ?>
                    <div class="py-3 lg:py-5 flex flex-col lg:flex-row lg:space-x-5">
                        <div class="w-full text-[16px] lg:text-[20px] ">
                            <span class="font-bold"><?php echo esc_html($item['title'] ?? ''); ?>:</span>
